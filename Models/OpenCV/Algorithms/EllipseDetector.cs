    ...
    public class EllipseDetector : KMean
    {
        ...
        public List<Tuple<OpenCvSharp.Mat, String>> Contours()
        {
            ...
            foreach (var pixel in keys)
            {
                ...
                {
                    OpenCvSharp.Cv2.DrawContours(kmeanContour, contours, i, Scalar.White, 2, LineTypes.AntiAlias);
                }
                ...
                {
                    kmeanEllipse.Ellipse(ellipse, Scalar.White, 2, LineTypes.AntiAlias);
                }
